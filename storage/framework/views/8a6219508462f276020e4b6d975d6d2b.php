...
} elseif ($_instance->childHasBeenRendered('l1888889907-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1888889907-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1888889907-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1888889907-0');
} else {
    $response = \Livewire\Livewire::mount('tables.vendor-document-request-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1888889907-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /www/wwwroot/new.chooozi.com/resources/views/livewire/vendor_document_request.blade.php ENDPATH**/ ?>
...
} elseif ($_instance->childHasBeenRendered('l609957311-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l609957311-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l609957311-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l609957311-0');
} else {
    $response = \Livewire\Livewire::mount('select.language-selector', []);
    $html = $response->html();
    $_instance->logRenderedChild('l609957311-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php /**PATH /www/wwwroot/new.chooozi.com/resources/views/livewire/auth/login.blade.php ENDPATH**/ ?>
                                ...
                                <tr>
                                    <td class="ms-content-body" style="word-break:break-word;font-family:'Inter', Helvetica, Arial, sans-serif;font-size:16px;line-height:24px;padding-top:40px;padding-bottom:40px;padding-right:50px;padding-left:50px;">
                                        ...
                                        <div style="margin-right:0;margin-left:0;line-height:28px;font-weight:600;font-size:21px;color:#111111;text-align:center;margin-top:0;margin-bottom:0px;">
                                            ...
                                            <img src="<?php echo e(url(setting('websiteLogo', asset('images/logo.png') ))); ?>" alt="" style="width: 32px;height: 32px;" class="mx-auto">
                                        </div>
                                        <p class="logo" style="margin-right:0;margin-left:0;line-height:28px;font-weight:600;font-size:21px;color:#111111;text-align:center;margin-top:0;margin-bottom:40px;"><?php echo e(env('APP_NAME','Glover')); ?></p>
...
<?php /**PATH /www/wwwroot/new.chooozi.com/resources/views/view/emails/plain.blade.php ENDPATH**/ ?>
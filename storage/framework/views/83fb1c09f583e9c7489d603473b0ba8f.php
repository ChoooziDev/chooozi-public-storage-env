...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.baseview','data' => ['title' => ''.e(__('Categories')).'','showNew' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
} elseif ($_instance->childHasBeenRendered('l30888399-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l30888399-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l30888399-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l30888399-0');
} else {
    $response = \Livewire\Livewire::mount('tables.category-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('l30888399-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['title' => ''.e(__('Color')).'','name' => 'color','placeholder' => '','type' => 'color','class' => 'h-10 p-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
<?php /**PATH /www/wwwroot/new.chooozi.com/resources/views/livewire/categories.blade.php ENDPATH**/ ?>
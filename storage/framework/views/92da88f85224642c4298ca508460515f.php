...
} elseif ($_instance->childHasBeenRendered('l691889620-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l691889620-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l691889620-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l691889620-0');
} else {
    $response = \Livewire\Livewire::mount('tables.driver-document-request-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('l691889620-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /www/wwwroot/new.chooozi.com/resources/views/livewire/driver_document_request.blade.php ENDPATH**/ ?>
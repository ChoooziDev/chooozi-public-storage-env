...
} elseif ($_instance->childHasBeenRendered('l2649402046-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2649402046-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2649402046-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2649402046-0');
} else {
    $response = \Livewire\Livewire::mount('header.vendor-selector');
    $html = $response->html();
    $_instance->logRenderedChild('l2649402046-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        <?php endif; ?>
...
<?php /**PATH /www/wwwroot/new.chooozi.com/resources/views/livewire/header/profile.blade.php ENDPATH**/ ?>
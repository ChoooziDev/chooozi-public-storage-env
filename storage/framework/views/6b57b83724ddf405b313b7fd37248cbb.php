...
} elseif ($_instance->childHasBeenRendered('l1092446991-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1092446991-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1092446991-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1092446991-0');
} else {
    $response = \Livewire\Livewire::mount('select.language-selector', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1092446991-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
<?php /**PATH /www/wwwroot/new.chooozi.com/resources/views/livewire/auth/register/register.blade.php ENDPATH**/ ?>
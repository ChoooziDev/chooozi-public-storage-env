...
} elseif ($_instance->childHasBeenRendered('l624055280-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l624055280-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l624055280-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l624055280-0');
} else {
    $response = \Livewire\Livewire::mount('tables.system-driver-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('l624055280-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /www/wwwroot/new.chooozi.com/resources/views/livewire/system_drivers.blade.php ENDPATH**/ ?>
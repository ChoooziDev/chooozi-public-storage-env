...
} elseif ($_instance->childHasBeenRendered('l1889857484-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1889857484-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1889857484-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1889857484-0');
} else {
    $response = \Livewire\Livewire::mount('settings.notification', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1889857484-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                 <?php echo $__env->renderComponent(); ?>
...
} elseif ($_instance->childHasBeenRendered('l1889857484-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1889857484-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1889857484-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1889857484-1');
} else {
    $response = \Livewire\Livewire::mount('settings.web-app-settings', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1889857484-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                 <?php echo $__env->renderComponent(); ?>
...
} elseif ($_instance->childHasBeenRendered('l1889857484-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l1889857484-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1889857484-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1889857484-2');
} else {
    $response = \Livewire\Livewire::mount('settings.page', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1889857484-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                 <?php echo $__env->renderComponent(); ?>
...
} elseif ($_instance->childHasBeenRendered('l1889857484-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l1889857484-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1889857484-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1889857484-3');
} else {
    $response = \Livewire\Livewire::mount('settings.custom-notification-message', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1889857484-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                 <?php echo $__env->renderComponent(); ?>
...
} elseif ($_instance->childHasBeenRendered('l1889857484-4')) {
    $componentId = $_instance->getRenderedChildComponentId('l1889857484-4');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1889857484-4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1889857484-4');
} else {
    $response = \Livewire\Livewire::mount('settings.file-limit', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1889857484-4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                 <?php echo $__env->renderComponent(); ?>
...
<?php /**PATH /www/wwwroot/new.chooozi.com/resources/views/livewire/settings/index.blade.php ENDPATH**/ ?>
...
} elseif ($_instance->childHasBeenRendered('l642291793-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l642291793-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l642291793-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l642291793-0');
} else {
    $response = \Livewire\Livewire::mount('select.language-selector', []);
    $html = $response->html();
    $_instance->logRenderedChild('l642291793-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /www/wwwroot/new.chooozi.com/resources/views/livewire/payment/wallet.blade.php ENDPATH**/ ?>
...
<?php endif; ?>
    ...
    <iframe src="<?php echo e(route('vendor.document.instructions')); ?>" frameborder="0" class="w-full" id="iframe"></iframe>
    <?php
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l3895062434-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3895062434-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3895062434-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3895062434-0');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l3895062434-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'agreedVendor','defer' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'noMargin' => true]); ?> <span><?php echo e(__('I agree with')); ?> <a
...
<?php $__env->stopPush(); ?>
<?php /**PATH /www/wwwroot/new.chooozi.com/resources/views/livewire/auth/register/partials/vendor.blade.php ENDPATH**/ ?>
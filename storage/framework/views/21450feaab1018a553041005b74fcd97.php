...
} elseif ($_instance->childHasBeenRendered('l1452546722-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1452546722-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1452546722-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1452546722-0');
} else {
    $response = \Livewire\Livewire::mount('tables.deleted-user-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1452546722-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /www/wwwroot/new.chooozi.com/resources/views/livewire/deleted_users.blade.php ENDPATH**/ ?>
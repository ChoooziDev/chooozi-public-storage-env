...
} elseif ($_instance->childHasBeenRendered('l807273584-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l807273584-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l807273584-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l807273584-0');
} else {
    $response = \Livewire\Livewire::mount('livewire-line-chart', ['lineChartModel' => $earningChart]);
    $html = $response->html();
    $_instance->logRenderedChild('l807273584-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                 <?php echo $__env->renderComponent(); ?>
...
} elseif ($_instance->childHasBeenRendered('l807273584-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l807273584-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l807273584-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l807273584-1');
} else {
    $response = \Livewire\Livewire::mount('livewire-line-chart', ['lineChartModel' => $usersChart]);
    $html = $response->html();
    $_instance->logRenderedChild('l807273584-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                 <?php echo $__env->renderComponent(); ?>
...
} elseif ($_instance->childHasBeenRendered('l807273584-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l807273584-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l807273584-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l807273584-2');
} else {
    $response = \Livewire\Livewire::mount('livewire-line-chart', ['lineChartModel' => $vendorsChart]);
    $html = $response->html();
    $_instance->logRenderedChild('l807273584-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                 <?php echo $__env->renderComponent(); ?>
...
} elseif ($_instance->childHasBeenRendered('l807273584-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l807273584-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l807273584-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l807273584-3');
} else {
    $response = \Livewire\Livewire::mount('livewire-line-chart', ['lineChartModel' => $ordersChart]);
    $html = $response->html();
    $_instance->logRenderedChild('l807273584-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                 <?php echo $__env->renderComponent(); ?>
...
<?php /**PATH /www/wwwroot/new.chooozi.com/resources/views/livewire/dashboard.blade.php ENDPATH**/ ?>
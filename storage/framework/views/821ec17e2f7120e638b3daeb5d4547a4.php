...
} elseif ($_instance->childHasBeenRendered('l3649456459-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3649456459-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3649456459-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3649456459-0');
} else {
    $response = \Livewire\Livewire::mount('select.language-selector', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3649456459-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
<?php /**PATH /www/wwwroot/new.chooozi.com/resources/views/livewire/auth/register/driver_register.blade.php ENDPATH**/ ?>